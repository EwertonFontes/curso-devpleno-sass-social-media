    ...
    return(
        <>
             <div className='grid grid-cols-1 md:grid-cols-2'>
                <div>
                    <Heading1>Dominios customizados</Heading1>
                </div>
                <div className='flex items-center'>
                    <Link href={`/app/${tenantId}/settings/domains/create`}>
                      <button
                          type="button"
            ...
            <section className="h-screen bg-gray-100/50">
                { data && data?.length === 0 && <Alert>Nenhum Dominio cadastrado</Alert> }
                { data && data?.length > 0 && (
